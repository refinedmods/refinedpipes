...
public class InsertorAttachmentType implements AttachmentType {
    ...
    private static final ResourceLocation ID = new ResourceLocation(RefinedPipes.ID, "insertor");
    private static final ResourceLocation ITEM_ID = new ResourceLocation(RefinedPipes.ID, "insertor_attachment");
