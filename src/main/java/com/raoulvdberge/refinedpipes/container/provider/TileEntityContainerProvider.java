...
public class TileEntityContainerProvider<T extends TileEntity> implements INamedContainerProvider {
    ...
    public TileEntityContainerProvider(ITextComponent name, Provider<T> provider, BlockPos pos) {
        this.name = name;
